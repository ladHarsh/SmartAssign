...
const model = genAI.getGenerativeModel({
  model: "gemini-2.0-flash-exp", // Latest fastest 2.x model with Pro-level quality
  generationConfig: {
    temperature: 0, // Fastest setting - deterministic output
    topK: 1, // Maximum speed - single best token selection
    topP: 0.1, // Very focused generation for speed
...
// Simple in-memory cache for ideal answers to speed up repeated grading
const idealAnswersCache = new Map();

// Optimized PDF text extraction with length limits for faster processing
